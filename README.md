Sorry about that—looks like the HTML centering tags and some table nesting were clashing with the renderer you're using. I've stripped out the `<div align="center">` wrappers (they don't always play nice everywhere) and restructured just the tricky spots (like the Visual Editor panels) into clean, side-by-side-ish Markdown sections without losing any content. Tables are now pure Markdown, code blocks are properly indented, and everything should render smoothly. No other changes—same exact text and structure.

```markdown
# 🎨⚡ Pixel UI - AI-Powered UI Component Generator with Live Visual Editing

![Pixel UI Banner](./docs/assets/banner.png)

**From Prompt to Perfect UI in Seconds - No More Repetitive AI Prompting**

[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-Try_Now-success?style=for-the-badge)](https://pixel-ui-web.vercel.app/)
[![Backend API](https://img.shields.io/badge/⚡_Backend_API-Live-blue?style=for-the-badge)](https://pixel-ui.fly.dev)
[![License](https://img.shields.io/badge/📄_License-AGPL_v3-orange?style=for-the-badge)](LICENSE)
...
```mermaid
graph LR
    A[💬 Enter Prompt] --> B[⚡ AI Starts Generating]
    B --> C[👁️ See Live Preview]
    C --> D[🎨 Click Any Element]
    D --> E[✏️ Edit Visually]
    E --> F[💾 Auto-Save]
    F --> G[🔄 Iterate or Generate New]
    G --> H[✅ Perfect Component]
...
Element Settings:
  ...
  Padding (px): [Top, Right, Bottom, Left]
  Margin (px): [Top, Right, Bottom, Left]
  Custom Classes: [Add Tailwind classes]
 
Actions:
  ✅ Apply instantly (no regeneration)
...
[![Open Playground](https://img.shields.io/badge/🚀_Open_Playground-pixel--ui--web.vercel.app-brightgreen?style=for-the-badge)](https://pixel-ui-web.vercel.app/)
[![API Health](https://img.shields.io/badge/⚡_API_Health-Check_Status-blue?style=for-the-badge)](https://pixel-ui.fly.dev/health)

### 🎬 **Demo Video**

[![Watch Demo](https://img.shields.io/badge/🎥_Watch_Full_Demo-See_It_In_Action-red?style=for-the-badge&logo=youtube)](https://youtube.com/your-demo-video)
...
| 🏠 **Landing Page**<br>![Landing](./docs/screenshots/landing.png)<br>*Clean, modern landing page with hero section* | 🔐 **Authentication**<br>![Auth](./docs/screenshots/auth.png)<br>*Secure login/register with email verification* |
| :-----------------------------------------------------------------------: | :-----------------------------------------------------------------------: |

| 📊 **Dashboard**<br>![Dashboard](./docs/screenshots/dashboard.png)<br>*All projects overview with quick access* | 🎨 **AI Playground**<br>![Playground](./docs/screenshots/playground.png)<br>*Real-time streaming generation interface* |
| :-----------------------------------------------------------------------: | :-----------------------------------------------------------------------: |

| ✏️ **Visual Editor**<br>![Editor](./docs/screenshots/visual-editor.png)<br>*Canva-like element editing panel* | 📸 **Image Generator**<br>![Images](./docs/screenshots/image-gen.png)<br>*AI-powered image generation with ImageKit* |
| :-----------------------------------------------------------------------: | :-----------------------------------------------------------------------: |
...
[![Docker Backend](https://img.shields.io/badge/🐳_Backend-talhadevelopes%2Fpixel--ui--server-blue?style=flat-square&logo=docker)](https://hub.docker.com/r/talhadevelopes/pixel-ui-server)
[![Docker Frontend](https://img.shields.io/badge/🐳_Frontend-talhadevelopes%2Fpixel--ui--client-blue?style=flat-square&logo=docker)](https://hub.docker.com/r/talhadevelopes/pixel-ui-client)
...
graph LR
    ...
    B --> C[🏗️ Build Server Image]
    B --> D[🏗️ Build Client Image]
...
[![Fork on GitHub](https://img.shields.io/badge/Fork-on_GitHub-blue?style=for-the-badge&logo=github)](https://github.com/talhadevelopes/pixel-ui/fork)
...
[![GitHub](https://img.shields.io/badge/GitHub-talhadevelopes-black?style=for-the-badge&logo=github)](https://github.com/talhadevelopes)
...
[![Try Demo](https://img.shields.io/badge/🎮_Try_Demo-Free_Access-brightgreen?style=for-the-badge)](https://pixel-ui-web.vercel.app/)
[![Star Repo](https://img.shields.io/badge/⭐_Star_Repo-Show_Support-yellow?style=for-the-badge)](https://github.com/talhadevelopes/pixel-ui)
[![Fork Project](https://img.shields.io/badge/🔱_Fork_Project-Contribute-blue?style=for-the-badge)](https://github.com/talhadevelopes/pixel-ui/fork)
