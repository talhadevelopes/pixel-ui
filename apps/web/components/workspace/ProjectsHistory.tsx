...
export function ProjectHistory() {
    ...
    const { data, isLoading, isError, error } = useQuery<ProjectWithRelations[], Error>({
    ...
    return (
        <div className="space-y-2">
            {projects.map((project) => {
                ...
                const isDeleting = deletingProjectId === project.projectId && deleteMutation.isPending;
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-xs text-muted-foreground">
                                {relativeDate ? `Created ${relativeDate}` : "Creation date unavailable"}
