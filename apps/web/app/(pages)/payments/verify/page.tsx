    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-lg items-center justify-center p-6">
      <Card className="w-full">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription>
            We&apos;re confirming your subscription status.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center gap-4 py-10">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            {isSuccess &&
              "Your subscription is now active. Enjoy the premium features!"}
            {!isLoading &&
              !isSuccess &&
              "We couldn&apos;t verify the payment. Please contact support if this persists."}
          </p>
        </CardContent>
